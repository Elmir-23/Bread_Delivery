      ...
      <div style={c.pad}>
        ...
        {isMorn && (
          <div style={c.block}>
            ...
            {["kura", "damiryolu"].map(t => (
              <div key={t} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: t === "damiryolu" ? 0 : 10 }}>
                <span style={{ fontSize: 14, fontWeight: 500 }}>{labels[t]}</span>
                <div style={c.counter}>
